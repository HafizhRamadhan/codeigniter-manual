  ...
  <header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= base_url('/data_diri'); ?>">Data Diri</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-5">
          <img src="<?= base_url('img/profil.jpeg') ?>" width="95%" alt="foto-profile">
        </div>
        <div class="col-7">
          Nama: Hafizh Ihsan Ramadhan <br>
          NIM: 23.240.0053 <br>
          Kelas: 3P41 <br>
          PROGDI: TI <br>
          Alamat: Batang, Jawa Tengah <br>
        </div>
      </div>
    </div>
